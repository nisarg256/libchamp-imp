...
{
  new (message_memory) quadruped_mujoco::msg::ContactsStamped(_init);
}

void ContactsStamped_fini_function(void * message_memory)
{
  auto typed_message = static_cast<quadruped_mujoco::msg::ContactsStamped *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ContactsStamped_message_member_array[2] = {
  {
    ...
    offsetof(quadruped_mujoco::msg::ContactsStamped, header),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ContactsStamped_message_members = {
  ...
  2,  // number of fields
  sizeof(quadruped_mujoco::msg::ContactsStamped),
...
{
  return &::quadruped_mujoco::msg::rosidl_typesupport_introspection_cpp::ContactsStamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, quadruped_mujoco, msg, ContactsStamped)() {
  return &::quadruped_mujoco::msg::rosidl_typesupport_introspection_cpp::ContactsStamped_message_type_support_handle;
}
