...
static const _ContactsStamped_type_support_symbol_names_t _ContactsStamped_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, quadruped_mujoco, msg, ContactsStamped)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, quadruped_mujoco, msg, ContactsStamped)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, quadruped_mujoco, msg, ContactsStamped)() {
  return &::quadruped_mujoco::msg::rosidl_typesupport_c::ContactsStamped_message_type_support_handle;
}
