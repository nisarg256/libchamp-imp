...
#include "quadruped_mujoco/msg/detail/joints__rosidl_typesupport_fastrtps_c.h"
...
using _Joints__ros_msg_type = quadruped_mujoco__msg__Joints;
...
size_t get_serialized_size_quadruped_mujoco__msg__Joints(
  const void * untyped_ros_message,
...
static uint32_t _Joints__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_quadruped_mujoco__msg__Joints(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_quadruped_mujoco
size_t max_serialized_size_quadruped_mujoco__msg__Joints(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Joints__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_quadruped_mujoco__msg__Joints(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, quadruped_mujoco, msg, Joints)() {
