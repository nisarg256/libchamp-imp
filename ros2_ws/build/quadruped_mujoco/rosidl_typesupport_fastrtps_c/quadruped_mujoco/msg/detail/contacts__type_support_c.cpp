...
#include "quadruped_mujoco/msg/detail/contacts__rosidl_typesupport_fastrtps_c.h"
...
using _Contacts__ros_msg_type = quadruped_mujoco__msg__Contacts;
...
static uint32_t _Contacts__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_quadruped_mujoco__msg__Contacts(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = quadruped_mujoco__msg__Contacts;
    is_plain =
      (
...
static size_t _Contacts__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_quadruped_mujoco__msg__Contacts(
