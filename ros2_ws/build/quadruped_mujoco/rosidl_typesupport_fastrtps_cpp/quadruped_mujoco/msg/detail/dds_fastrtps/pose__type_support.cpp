...
#include "quadruped_mujoco/msg/detail/pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const quadruped_mujoco::msg::Pose & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  quadruped_mujoco::msg::Pose & ros_message)
{
  // Member: position
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = quadruped_mujoco::msg::Pose;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const quadruped_mujoco::msg::Pose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<quadruped_mujoco::msg::Pose *>(
    untyped_ros_message);
...
{
  return &quadruped_mujoco::msg::typesupport_fastrtps_cpp::_Pose__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, quadruped_mujoco, msg, Pose)() {
  return &quadruped_mujoco::msg::typesupport_fastrtps_cpp::_Pose__handle;
}
