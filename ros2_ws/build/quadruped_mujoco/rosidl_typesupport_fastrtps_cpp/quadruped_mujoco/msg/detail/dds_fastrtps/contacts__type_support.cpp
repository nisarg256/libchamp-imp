...
#include "quadruped_mujoco/msg/detail/contacts__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const quadruped_mujoco::msg::Contacts & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  quadruped_mujoco::msg::Contacts & ros_message)
{
  // Member: contacts
  {
    cdr >> ros_message.contacts;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = quadruped_mujoco::msg::Contacts;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const quadruped_mujoco::msg::Contacts *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<quadruped_mujoco::msg::Contacts *>(
    untyped_ros_message);
...
{
  return &quadruped_mujoco::msg::typesupport_fastrtps_cpp::_Contacts__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, quadruped_mujoco, msg, Contacts)() {
  return &quadruped_mujoco::msg::typesupport_fastrtps_cpp::_Contacts__handle;
}
