...
bool quadruped_mujoco__msg__contacts__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("quadruped_mujoco.msg._contacts.Contacts", full_classname_dest, 39) == 0);
  }
  quadruped_mujoco__msg__Contacts * ros_message = _ros_message;
  {  // contacts
...
PyObject * quadruped_mujoco__msg__contacts__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("quadruped_mujoco.msg._contacts");
