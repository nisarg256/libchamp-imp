...
static const _Joints_type_support_symbol_names_t _Joints_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, quadruped_mujoco, msg, Joints)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, quadruped_mujoco, msg, Joints)),
  }
};
...
{
  return &::quadruped_mujoco::msg::rosidl_typesupport_cpp::Joints_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, quadruped_mujoco, msg, Joints)() {
  return get_message_type_support_handle<quadruped_mujoco::msg::Joints>();
}
