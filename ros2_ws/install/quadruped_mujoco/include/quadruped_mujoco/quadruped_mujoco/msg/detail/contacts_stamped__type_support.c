...
#include <stddef.h>
#include "quadruped_mujoco/msg/detail/contacts_stamped__rosidl_typesupport_introspection_c.h"
...
void quadruped_mujoco__msg__ContactsStamped__rosidl_typesupport_introspection_c__ContactsStamped_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  quadruped_mujoco__msg__ContactsStamped__init(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember quadruped_mujoco__msg__ContactsStamped__rosidl_typesupport_introspection_c__ContactsStamped_message_member_array[2] = {
  {
    ...
    offsetof(quadruped_mujoco__msg__ContactsStamped, header),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers quadruped_mujoco__msg__ContactsStamped__rosidl_typesupport_introspection_c__ContactsStamped_message_members = {
  "quadruped_mujoco__msg",  // message namespace
  "ContactsStamped",  // message name
  2,  // number of fields
  sizeof(quadruped_mujoco__msg__ContactsStamped),
  quadruped_mujoco__msg__ContactsStamped__rosidl_typesupport_introspection_c__ContactsStamped_message_member_array,  // message members
  quadruped_mujoco__msg__ContactsStamped__rosidl_typesupport_introspection_c__ContactsStamped_init_function,  // function to initialize message memory (memory has to be allocated)
  quadruped_mujoco__msg__ContactsStamped__rosidl_typesupport_introspection_c__ContactsStamped_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t quadruped_mujoco__msg__ContactsStamped__rosidl_typesupport_introspection_c__ContactsStamped_message_type_support_handle = {
  0,
  &quadruped_mujoco__msg__ContactsStamped__rosidl_typesupport_introspection_c__ContactsStamped_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, quadruped_mujoco, msg, ContactsStamped)() {
  ...
  return &quadruped_mujoco__msg__ContactsStamped__rosidl_typesupport_introspection_c__ContactsStamped_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
